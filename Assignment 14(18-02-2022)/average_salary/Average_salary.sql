use office
create table Average_salary(EMPLOYEE_ID int not null primary key,FIRST_NAME varchar(255),LAST_NAME varchar(255),
...
alter table Average_salary modify EMPLOYEE_ID int not null auto_increment
alter table Average_salary modify JOB_ID varchar(255) 
insert into Average_salary values(100,'SHRUTHIKA','ARJUN',
...
select JOB_ID, COUNT(*), avg(salary) as average_salary from Average_salary group by JOB_ID 